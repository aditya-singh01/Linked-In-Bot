...
phone_number = "9084553079"        # Enter your 10 digit number in quotes Eg: "9876543210"

# What is your current city? (Used when company asks for city or location in application.)
current_city = "Delhi"                  # e.g. "Delhi", "New Delhi", "Bangalore"
'''
Note: If left empty as "", the bot will fill in the job's work location instead.
'''

# Address, not so common question but some job applications make it required!
street = "W-ZC-11, Patel Garden, Sector-15"
state = "Delhi"
zipcode = "110059"
country = "India"

## US Equal Opportunity questions (must use one of the validator-allowed values below)
# Ethnicity/race: US EEO categories only. For India use "Asian" (standard) or "Other" or "Decline"
